...
import { MessageListChildrenProps } from "./MessageList";
...
export declare class MessageListImpl extends React.Component<MessageListChildrenProps> {
    private messageList;
    ...
    render(): JSX.Element;
    shouldComponentUpdate(nextProps: MessageListChildrenProps): boolean;
